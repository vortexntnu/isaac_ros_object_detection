...
def generate_launch_description():
    """Launch the DNN Image encoder, TensorRT node and YOLOv26 decoder node."""
    launch_args = [
    ...
    yolov26_encoder_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'component_container_name': 'yolov26_container',
    ...
    yolov26_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[image_resize_node_left, tensor_rt_node, yolov26_decoder_node],
        output='screen'
    )

    yolov26_visualizer_node = Node(
        package='isaac_ros_yolov26',
        executable='isaac_ros_yolov26_visualizer.py',
        name='yolov26_visualizer',
        remappings=[('yolov26_encoder/resize/image', 'front_stereo_camera/left_rgb/image_resize')]
    )
    ...
    rqt_image_view_node = Node(
        ...
        name='image_view',
        arguments=['/yolov26_processed_image'],
        parameters=[
                {'my_str': 'rgb8'},
        ]
    )
    ...
    return launch.LaunchDescription(launch_args +
                                    [yolov26_container, yolov26_encoder_launch,
                                     yolov26_visualizer_node, rqt_image_view_node])
